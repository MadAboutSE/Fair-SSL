...
def get_counts(clf, cluster_map, x_train, y_train, x_test, y_test, test_df, biased_col, metric='aod'):
    ...
    for predicted in predictions:
        y_pred.append(cluster_map[predicted])
...
def measure_final_score(test_df, clf, cluster_map, X_train, y_train, X_test, y_test, biased_col, metric):
    df = copy.deepcopy(test_df)
    return get_counts(clf, cluster_map, X_train, y_train, X_test, y_test, df, biased_col, metric=metric)